...
spec:
  cruiseControl:
    apiUsers:
     ...
     ...
```
(1) A type field is added here for configuration flexibility in the future. e.g. Gives us the option to have other methids of configuring API users other than using `secrets`
