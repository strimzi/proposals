...
This proposal is about simplifying the KafkaConfig files of the Java modules of the [Strimzi Client Examples repo](https://github.com/strimzi/client-examples). 
...
In addition to that, we found adding Kafka client configuration updates to the KafkaConfig files of the Java modules in the [Strimzi Client Examples repo](https://github.com/strimzi/client-examples) to be a little more verbose and messier than necessary. 
